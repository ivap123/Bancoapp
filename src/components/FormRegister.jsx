      ...
      <div className="row justify-content-center align-items-center" style={{ minHeight: "100vh", margin: "0" }}>
        <div className="col-md-8 col-lg-6">
          ...
          <div className="text-center mb-4">
            <h1 className="text-white fw-bold" style={{ fontSize: "2.5rem", textShadow: "0 0 10px rgba(111, 66, 193, 0.7)" }}>
              <span style={{ color: "#a17fe0" }}>Banco</span>Digital
            </h1>
            <p className="text-light" style={{ fontSize: "1.1rem", letterSpacing: "1px" }}>Crea tu cuenta en simples pasos</p>
          </div>
          ...
          <div className="card shadow-lg border-0" style={{ 
            ...
            <div className="card-header text-white text-center py-3" style={{ 
              ...
              <h3 className="mb-0" style={{ fontWeight: "600" }}>Registro de Cuenta</h3>
            </div>
            <div className="card-body p-4">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  <label htmlFor="rut" className="form-label text-light">RUT</label>
                  <input
                    type="text"
                    className="form-control"
                    style={{ 
