...
import { doc, getDoc } from 'firebase/firestore'; // Importa doc y getDoc
...
const LoginForm = () => {
  ...
  const handleLogin = async e => {
    ...
    try {
      ...
      // Consulta directa al documento del usuario por uid
      ...
      <div className="row justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
        <div className="col-md-8 col-lg-6 col-xl-4">
          ...
          <div
            ...
            style={{ backgroundColor: '#1a1a1a', borderRadius: '15px' }}>
            <div
              className="card-header bg-dark text-white text-center py-3"
              style={{ borderBottom: '2px solid #6f42c1', borderRadius: '15px 15px 0 0' }}>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="d-grid gap-2">
                  <button
                    ...
                    style={{ backgroundColor: '#6f42c1', padding: '12px', fontSize: '1.1rem' }}>
                    Iniciar Sesión
                  </button>
                </div>
